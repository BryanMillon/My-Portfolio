...
export default function Skills({skills}: Props) {
  return (
    <motion.div
      ...
      className="flex relative flex-col justify-center items-center text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-screen xl:space-y-0 mx-auto overflow-scroll "
    >
